-- Migration: facturation_function_created_by
-- Module: facturation
-- Gate: Updates RPC function to set created_by field
-- Created: 2026-01-23

-- =============================================================================
-- DROP OLD FUNCTION AND CREATE UPDATED VERSION WITH created_by
-- =============================================================================
...
comment on function public.create_invoice_with_line_item(uuid, uuid, text, text, boolean) is
  'Creates an invoice with its initial service line item and optional file opening fee. Sets created_by to current user. Uses SECURITY DEFINER to ensure line items can be inserted.';
